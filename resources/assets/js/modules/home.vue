...
export default {
    ...
    data() {
        return {
            ...
            columnsTitles: {'totalstorage': 'Total storage', 'used': 'Used storage', 'used_percent': 'Used (%)', 'price': 'Price (SCP/TB/month)'},
            formatters: {
                ...
                price: function(str, entry, raw){
                    ...
                    return Math.round(entry.storageprice/1e15*4320)+" SCP";
                },
